var FineArt = window.FineArt || {}; FineArt.Helpers = FineArt.Helpers || {};
FineArt.Helpers = {
	...
	setupDev: function(){
		var isDev = false;
		if(AppData.UserId==1){
			FineArt.Helpers.createDevItems();
		}
	},
	...
	createDevItems: function(){
		FineArt.Helpers.createDevNavItems();
		FineArt.Helpers.showNavigatorInfo();
