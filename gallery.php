...
<body class="page-gallery layout-uniform width-320 v2 test-php" id="" data-arttype="<?php echo($type)?>">
	<div class="content">
		<div class="main">
			...
			<div class="gallery-menu">
				<div class="gallery-sections">
					<ul class="list-menu menu-opened">
						...
						<li class="<?php echo($paintingsMenuClass)?>">
							<?php echo($paintingsAnchor)?>
							
						</li>
						<li class="<?php echo($installationsMenuClass)?>">
							<?php echo($installationsAnchor)?>
