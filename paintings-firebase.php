...
<script id="template-gallery-item" type="text/x-handlebars-template">
					<li data-index="{{index}}"><a href="img/artwork/paintings/large/{{imgUrl}}" data-width="{{width}}" data-height="{{height}}" data-orientation="{{orientation}}" data-index="{{index}}"><img width="320" height="240" src="img/artwork/paintings/thumbnail/{{imgUrl}}" alt="{{title}}" title="{{title}}" /></a></li>
</script>
